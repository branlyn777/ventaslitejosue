...
<div class="row">
    ...
    <div class="col-sm-12 col-md-4">
        <div class="form-group">
            ...
            <input type="text" wire:model.lazy="phone"
             class="form-control" placeholder="ej. 63860467" maxlength="10">
    ...
    <div class="col-sm-12 col-md-6">
        <div class="form-group">
            ...
            <input type="text" wire:model.lazy="email"
             class="form-control" placeholder="luisfax@gmail.com">
    ...
    <div class="col-sm-12 col-md-6">
        <div class="form-group">
            ...
            accept="image/x-png, image/jpeg, image/gif" class="form-control">
